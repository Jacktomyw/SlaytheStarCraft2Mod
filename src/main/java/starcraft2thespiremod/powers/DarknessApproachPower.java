...
public class DarknessApproachPower extends AbstractPower {
	public static final String POWER_ID = starcraft2thespiremod.StarCraft2theSpireMod.makeID("DarknessApproachPower");
	private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
	public static final String NAME = powerStrings.NAME;
	public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
	public static final String IMG = StarCraft2theSpireMod.makePath(StarCraft2theSpireMod.DARKNESSAPPROACH_POWER);
