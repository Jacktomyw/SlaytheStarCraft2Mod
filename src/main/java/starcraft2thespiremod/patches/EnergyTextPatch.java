package starcraft2thespiremod.patches;
...
public class EnergyTextPatch {
  ...
  static {
    EnergyTextPatch.r = Pattern.compile("\\[([RGBP])\\](\\.?) ");
  ...
  public static class RenderDescriptionEnergy {
      ...
      return new ExprEditor() {
        public void edit(final MethodCall m) throws CannotCompileException {
          if (m.getClassName().equals("java.lang.String") && m.getMethodName().equals("equals")) {
            m.replace(
                "{ $_ = starcraft2thespiremod.patches.EnergyTextPatch.RenderDescriptionEnergy.replaceEquals(tmp, (java.lang.String)$1); }");
          }
        }
        ...
        public void edit(final FieldAccess m) throws CannotCompileException {
          if (m.getClassName().equals("com.megacrit.cardcrawl.helpers.ImageMaster") && m
            ...
            m.replace(
                "{ $_ = starcraft2thespiremod.patches.EnergyTextPatch.RenderDescriptionEnergy.replaceOrbField(tmp, this.card); }");
          }
        }
      };
    }
    ...
    public static boolean replaceEquals(final String tmp, final String originalArg) {
      return tmp.equals(originalArg) || (tmp.equals("[P]") && originalArg.equals("[G]"));
    }
