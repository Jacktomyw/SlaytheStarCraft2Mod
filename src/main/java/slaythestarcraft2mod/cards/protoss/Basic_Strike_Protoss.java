...
public class Basic_Strike_Protoss extends CustomCard{
	...
	public static final String ID = slaythestarcraft2mod.SlaytheStarCraft2Mod.makeID("Basic_Strike_Protoss");
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	
	public static final String IMG = ImgInitializer.makePath(ImgInitializer.BASIC_STRIKE_PROTOSS);
