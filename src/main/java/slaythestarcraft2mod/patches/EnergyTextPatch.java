package slaythestarcraft2mod.patches;
      ...
      return new ExprEditor() {
        public void edit(final MethodCall m) throws CannotCompileException {
          if (m.getClassName().equals("java.lang.String") && m.getMethodName().equals("equals")) {
            m.replace(
                "{ $_ = slaythestarcraft2mod.patches.EnergyTextPatch.RenderDescriptionEnergy.replaceEquals(tmp, (java.lang.String)$1); }");
          }
        }
        ...
        public void edit(final FieldAccess m) throws CannotCompileException {
          if (m.getClassName().equals("com.megacrit.cardcrawl.helpers.ImageMaster") && m
            ...
            m.replace(
                "{ $_ = slaythestarcraft2mod.patches.EnergyTextPatch.RenderDescriptionEnergy.replaceOrbField(tmp, this.card); }");
          }
        }
      };
    }
