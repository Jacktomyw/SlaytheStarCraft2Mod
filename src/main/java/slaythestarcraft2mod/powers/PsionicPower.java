...
import static slaythestarcraft2mod.patches.CardTagsEnum.*;
...
public class PsionicPower extends AbstractPower {
	...
	public float atDamageGive(float damage, DamageType type) {
		return type == slaythestarcraft2mod.patches.DamageTypeEnum.NOPSIONIC ? damage : damage + (float) this.amount;
	}
